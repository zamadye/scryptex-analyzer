    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <Tabs defaultValue="info" value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="mb-6">
          ...
          <TabsTrigger value="credits">Credits & Transactions</TabsTrigger>
        </TabsList>
                    ...
                    {user.analyzedProjects && user.analyzedProjects.length > 0 ? (
                      user.analyzedProjects.slice(0, 3).map((project, index) => (
                        <div key={index} className="flex items-center p-3 bg-blue-50 rounded-lg">
                          ...
                          <div>
                            <p className="font-medium">Analyzed Project</p>
                      ...
                      <p className="text-gray-500 text-sm">No recent achievements</p>
                    )}
                  </div>
                </div>
              </CardContent>
